...
\hspace{5mm}\small Interestingly, scholars found that in fact \pali{isipatana} came from Sanskrit \pali{\d r\'syav\d rjana} (enclosure of antelopes).\footnote{\citealp[p.~4]{oberlies:grammar}} So, the reading of \pali{isi} (\pali{\d r\d si}, seer) from \pali{\d r\'sya} (antelope) is a mistake.\\
\hline
\end{longtable}
